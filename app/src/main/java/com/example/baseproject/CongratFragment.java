...
public class CongratFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int score = CongratFragmentArgs.fromBundle(getArguments()).getScoreArg();
        ((TextView) view.findViewById(R.id.btnScore)).setText("Score: " +score);
        view.findViewById(R.id.btnCongratRetest).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController navController = Navigation.findNavController(view);
                navController.popBackStack(R.id.quizzFragment,false);
            }
        });
        return view;
    }
